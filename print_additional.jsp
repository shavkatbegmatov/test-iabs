...
%><t:page>
	...
	String service_procent = request.getParameter("service_procent");
	...
	String file_name="qoshimcha---inn-" + client_inn + "---" + contract_date;
...
//	license.setLicense(new FileInputStream("/u01/app/oracle/webapp/iabs/ibs/qqb/contracts/documents/Aspose.Total.Java.lic"));
	...
	Document doc = null;
//	stream = new FileInputStream("/u01/app/oracle/webapp/iabs/ibs/qqb/contracts/documents/qoshimcha-20230412.docx");
	stream = new FileInputStream("/u01/webapp/iabs/ibs/qqb/contracts/documents/qoshimcha-20230412.docx");
...
//	request.setCharacterEncoding("UTF-8");
	...
	contract_number = contract_number + "/01";
	...
	doc.getRange().replace("{/service_procent/}",	service_procent,	new FindReplaceOptions(FindReplaceDirection.FORWARD));
